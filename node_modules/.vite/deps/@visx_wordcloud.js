...
var require_d3_cloud = __commonJS({
  "node_modules/d3-cloud/index.js"(exports, module) {
    ...
    module.exports = function() {
      var size = [256, 256], text = cloudText, font = cloudFont, fontSize = cloudFontSize, fontStyle = cloudFontNormal, fontWeight = cloudFontNormal, padding = cloudPadding, spiral = archimedeanSpiral, words = [], timeInterval = Infinity, event = dispatch2("word", "end"), timer = null, random = Math.random, rotate = () => (~~(random() * 6) - 3) * 30, cloud = {}, canvas = cloudCanvas;
...
// node_modules/@visx/wordcloud/esm/Wordcloud.js
...
// node_modules/@visx/wordcloud/esm/useWordcloud.js
var import_react2 = __toESM(require_react());
var import_d3_cloud = __toESM(require_d3_cloud());
function useWordcloud(_ref) {
  var width = _ref.width, height = _ref.height, font = _ref.font, fontSize = _ref.fontSize, fontStyle = _ref.fontStyle, fontWeight = _ref.fontWeight, padding = _ref.padding, random = _ref.random, rotate = _ref.rotate, spiral = _ref.spiral, words = _ref.words;
  var _useState = (0, import_react2.useState)([]), cloudWords = _useState[0], setCloudWords = _useState[1];
  (0, import_react2.useEffect)(function() {
    if (width === 0 || height === 0) {
      return;
    }
    var layout = (0, import_d3_cloud.default)();
...
function Wordcloud(props) {
  var children = props.children, wordcloudConfig = _objectWithoutPropertiesLoose2(props, _excluded2);
  var width = wordcloudConfig.width, height = wordcloudConfig.height;
  var words = useWordcloud(wordcloudConfig);
  if (width === 0 || height === 0) return null;
  return import_react3.default.createElement("svg", {
    width,
    height
  }, import_react3.default.createElement(Group, {
    left: width / 2,
    top: height / 2
  }, children(words)));
}
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=@visx_wordcloud.js.map
